        ...
        <>
            ...
            >
                <div className='w-full md:w-3/5 lg:w-2/5 h-full flex justify-center items-center flex-col content-center ring-4 bg-white bg-opacity-75 rounded-lg p-4 md:p-6'>
                    ...
                    <p className='xl:text-xl text-xs w-3/4 text-wrap text-slate-950 mt-3.5 mb-3.5'>At Mental Health App, we believe in the power of understanding, compassion, and accessible support to transform lives. Our mission is to guide individuals towards a path of mental wellness and resilience, breaking down the barriers of stigma and shame that too often surround mental health.</p>
            ...
            <div className='flex justify-center items-center flex-col xl:flex-row w-full xl:h-2/4 h-auto'>
               ...
               <div className='w-1/2 flex justify-center items-center'>
                  <img src={girlImage} alt="A girl reflecting" />
                </div>
            </div>
           ...
           <div className='flex items-center justify-center flex-col lx:flex-row gap-8 p-5 bg-white shadow-lg rounded-lg max-w-4xl mx-auto'>
                <div className='w-full lg:w-1/2'>
                    <img className='h-auto lx:w-96 w-auto rounded-lg shadow-md' src={imageNews} alt="News about mental health" />
                </div>
                <div className='w-full lg:w-1/2'>
           ...
           <div className='w-full flex justify-center items-center bg-blue-50 p-4'>
                <div className='max-w-4xl flex flex-col md:flex-row items-center gap-8'>
                    ...
                    <div className='md:w-1/2 flex justify-center p-4'>
                        <img className='h-auto w-auto' src={imageQuiz} alt="Quiz game illustration" />
                    </div>
                </div>
            </div>
        </>
